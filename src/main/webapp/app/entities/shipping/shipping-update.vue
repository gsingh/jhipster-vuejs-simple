    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="platemillApp.shipping.home.createOrEditLabel" v-text="$t('platemillApp.shipping.home.createOrEditLabel')">Create or edit a Shipping</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('platemillApp.shipping.shippingDate')" for="shipping-shippingDate">Shipping Date</label>
                        ...
                        <div v-if="$v.shipping.shippingDate.$anyDirty && $v.shipping.shippingDate.$invalid">
                            <small class="form-text text-danger" v-if="!$v.shipping.shippingDate.required" v-text="$t('entity.validation.required')">
                                This field is required.
                            </small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('platemillApp.shipping.shift')" for="shipping-shift">Shift</label>
                        ...
                        <div v-if="$v.shipping.shift.$anyDirty && $v.shipping.shift.$invalid">
                            <small class="form-text text-danger" v-if="!$v.shipping.shift.required" v-text="$t('entity.validation.required')">
                                This field is required.
                            </small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('platemillApp.shipping.noOfWagons')" for="shipping-noOfWagons">No Of Wagons</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('platemillApp.shipping.noOfTrailers')" for="shipping-noOfTrailers">No Of Trailers</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('platemillApp.shipping.shippedTonnage')" for="shipping-shippedTonnage">Shipped Tonnage</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-bind:value="$t('platemillApp.shipping.manager')" for="shipping-manager">Manager</label>
