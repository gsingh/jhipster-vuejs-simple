...
/**
 * REST controller for managing {@link com.plate.mill.domain.ShiftManager}.
 */
@RestController
@RequestMapping("/api")
public class ShiftManagerResource {
    ...
    public ResponseEntity<ShiftManager> updateShiftManager(@Valid @RequestBody ShiftManager shiftManager) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, shiftManager.getId().toString()))
            .body(result);
    }
